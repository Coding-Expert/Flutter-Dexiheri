...
class BuildingResultPage extends StatefulWidget {
  String category;
  String category2;
  String category3;
  Job job;
  ...
  BuildingResultPageState createState ()=> BuildingResultPageState();
}

class BuildingResultPageState extends State<BuildingResultPage> {
                        ...
                        itemBuilder: (context, index){
                          return Dismissible(
                            ...
                            child: GestureDetector(
                              onTap: () {
                                Navigator.push(context, MaterialPageRoute(builder: (context) => BuildingDetailPage(
