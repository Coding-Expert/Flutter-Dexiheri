        ...
        child: Center(
          child: Column(
            children: [
              ...
              Text("Title: ${widget.document.title == null ? "" : widget.document.title}", textAlign: TextAlign.center, style: TextStyle(color: Colors.black, fontSize: 20, fontWeight: FontWeight.bold),maxLines: 2,),
              Padding(padding: EdgeInsets.only(top: 10)),
              Text("Category: ${widget.document.category2 == null ? "" : widget.document.category2}", style: TextStyle(color: Colors.black, fontSize: 20, fontWeight: FontWeight.bold),maxLines: 2, textAlign: TextAlign.center,),
              Padding(padding: EdgeInsets.only(top: 10)),
              Text("Subcategory: ${widget.document.category3 == null ? "" : widget.document.category3}", style: TextStyle(color: Colors.black, fontSize: 20, fontWeight: FontWeight.bold),maxLines: 2, textAlign: TextAlign.center,),
              Padding(padding: EdgeInsets.only(top: 10)),
