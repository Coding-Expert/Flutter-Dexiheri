...
class BeachDetailPage extends StatefulWidget {
  ...
  BeachDetailPageState createState ()=> BeachDetailPageState();
}

class BeachDetailPageState extends State<BeachDetailPage> {
        ...
        child: Center(
          child: Column(
            children: [
              ...
              Text("Τίτλοσ: ${widget.document.title == null ? "" : widget.document.title}", textAlign: TextAlign.center, style: TextStyle(color: Colors.black, fontSize: 20, fontWeight: FontWeight.bold),maxLines: 2,),
              Padding(padding: EdgeInsets.only(top: 10)),
