...
class BeachResultPage extends StatefulWidget {
  String category;
  String category2;
  String category3;
  Job job;
  ...
  BeachResultPageState createState ()=> BeachResultPageState();
}

class BeachResultPageState extends State<BeachResultPage> {
                        ...
                        itemBuilder: (context, index){
                          return Dismissible(
                            ...
                            child: GestureDetector(
                              onTap: () {
                                Navigator.push(context, MaterialPageRoute(builder: (context) => BeachDetailPage(
