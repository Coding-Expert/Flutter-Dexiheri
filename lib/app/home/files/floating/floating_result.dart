...
import 'package:dexiheri/app/home/files/floating/floating_detail.dart';
...
class FloatingResultPage extends StatefulWidget {
  String category;
  String category2;
  String category3;
  Job job;
  ...
  FloatingResultPageState createState ()=> FloatingResultPageState();
}

class FloatingResultPageState extends State<FloatingResultPage> {
                        ...
                        itemBuilder: (context, index){
                          return Dismissible(
                            ...
                            child: GestureDetector(
                              onTap: () {
                                Navigator.push(context, MaterialPageRoute(builder: (context) => FloatingDetailPage(
