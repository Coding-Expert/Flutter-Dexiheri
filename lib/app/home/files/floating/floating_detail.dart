...
class FloatingDetailPage extends StatefulWidget {
  ...
  FloatingDetailPageState createState ()=> FloatingDetailPageState();
}

class FloatingDetailPageState extends State<FloatingDetailPage> {
