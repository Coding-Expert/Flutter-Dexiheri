...
class CertificationResultPage extends StatefulWidget {
  ...
  CertificationResultPageState createState ()=> CertificationResultPageState();
}

class CertificationResultPageState extends State<CertificationResultPage> {
