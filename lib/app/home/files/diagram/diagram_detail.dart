...
class DiagramDetailPage extends StatefulWidget {
  ...
  DiagramDetailPageState createState ()=> DiagramDetailPageState();
}
class DiagramDetailPageState extends State<DiagramDetailPage> {
