...
class DiagramResultPage extends StatefulWidget {
  String category;
  String category2;
  String category3;
  Job job;
  ...
  DiagramResultPageState createState ()=> DiagramResultPageState();
}

class DiagramResultPageState extends State<DiagramResultPage> {
                        ...
                        itemBuilder: (context, index){
                          return Dismissible(
                            ...
                            child: GestureDetector(
                              onTap: () {
                                Navigator.push(context, MaterialPageRoute(builder: (context) => CertificationDetailPage(
