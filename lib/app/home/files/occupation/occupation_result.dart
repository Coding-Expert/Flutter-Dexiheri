...
class OccupationResultPage extends StatefulWidget {
  String category;
  String category2;
  String category3;
  Job job;
  OccupationResultPage({ 
    Key key,
    this.category,
    this.category2,
    this.category3,
  ...
  OccupationResultPageState createState ()=> OccupationResultPageState();
}

class OccupationResultPageState extends State<OccupationResultPage> {
                        ...
                        itemBuilder: (context, index){
                          return Dismissible(
                            ...
                            child: GestureDetector(
                              onTap: () {
                                Navigator.push(context, MaterialPageRoute(builder: (context) => OccupationDetailPage(
