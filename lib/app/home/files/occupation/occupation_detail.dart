...
class OccupationDetailPage extends StatefulWidget {
  ...
  OccupationDetailPageState createState ()=> OccupationDetailPageState();
}

class OccupationDetailPageState extends State<OccupationDetailPage> {
