...
class NotificationResultPage extends StatefulWidget {
  String category;
  String category2;
  String category3;
  Job job;

  NotificationResultPage({
    Key key,
    this.category,
    this.category2,
    this.category3,
  ...
  NotificationResultPageState createState ()=> NotificationResultPageState();
}

class NotificationResultPageState extends State<NotificationResultPage> {
                        ...
                        itemBuilder: (context, index){
                          return Dismissible(
                            ...
                            child: GestureDetector(
                              onTap: () {
                                Navigator.push(context, MaterialPageRoute(builder: (context) => NotificationDetailPage(
