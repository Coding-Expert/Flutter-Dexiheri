...
import 'package:dexiheri/app/home/files/corporate/corporate_detail.dart';
...
class CorporateResultPage extends StatefulWidget {
  String category;
  String category2;
  String category3;
  Job job;
  ...
  CorporateResultPageState createState ()=> CorporateResultPageState();
}

class CorporateResultPageState extends State<CorporateResultPage> {
                        ...
                        itemBuilder: (context, index){
                          return Dismissible(
                            ...
                            child: GestureDetector(
                              onTap: () {
                                Navigator.push(context, MaterialPageRoute(builder: (context) => CorporateDetailPage(
