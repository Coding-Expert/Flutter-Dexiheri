...
import 'package:dexiheri/app/home/files/lease/lease_detail.dart';
...
class LeaseResultPage extends StatefulWidget {
  String category;
  String category2;
  String category3;
  Job job;
  ...
  LeaseResultPageState createState ()=> LeaseResultPageState();
}

class LeaseResultPageState extends State<LeaseResultPage> {
                        ...
                        itemBuilder: (context, index){
                          return Dismissible(
                            ...
                            child: GestureDetector(
                              onTap: () {
                                Navigator.push(context, MaterialPageRoute(builder: (context) => LeaseDetailPage(
