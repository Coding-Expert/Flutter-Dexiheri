...
import 'package:dexiheri/app/home/files/courts/courts_detail.dart';
...
class CourtsResultPage extends StatefulWidget {
  String category;
  String category2;
  String category3;
  Job job;
  ...
  CourtsResultPageState createState ()=> CourtsResultPageState();
}

class CourtsResultPageState extends State<CourtsResultPage> {
                        ...
                        itemBuilder: (context, index){
                          return Dismissible(
                            ...
                            child: GestureDetector(
                              onTap: () {
                                Navigator.push(context, MaterialPageRoute(builder: (context) => CourtsDetailPage(
