...
import 'package:dexiheri/app/home/files/protection/protection_detail.dart';
...
class ProtectionResultPage extends StatefulWidget {
  String category;
  String category2;
  String category3;
  Job job;

  ProtectionResultPage({
    Key key,
    this.category,
    this.category2,
    this.category3,
  ...
  ProtectionResultPageState createState ()=> ProtectionResultPageState();
}

class ProtectionResultPageState extends State<ProtectionResultPage> {
                        ...
                        itemBuilder: (context, index){
                          return Dismissible(
                            ...
                            child: GestureDetector(
                              onTap: () {
                                Navigator.push(context, MaterialPageRoute(builder: (context) => ProtectionDetailPage(
